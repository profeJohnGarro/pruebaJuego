function initCanvas(){
    ...
    var laserImage = new Image(); // laser 
    ...
    naveImage.src       = "images/simbolo_paz-pic.png"; //Spaceship picture
    laserImage.src      = "images/planta-pic.png"; //laser picture

    // Enemigos fotos
    enemiespic1.src     = "images/arma1.png";
    enemiespic2.src     = "images/arma_2.png"; //Enemies picture
    ...
    var enemies = [
                   new enemyTemplate({id: "arma1", x: 100, y: -20, w: 50, h: 30 }),
                   new enemyTemplate({id: "arma2", x: 225, y: -20, w: 50, h: 30 }),
                   new enemyTemplate({id: "arma3", x: 350, y: -20, w: 80, h: 30 }),
                   new enemyTemplate({id: "arma4", x:100,  y:-70,  w:80,  h: 30}),
                   new enemyTemplate({id: "arma5", x:225,  y:-70,  w:50,  h: 30}),
                   new enemyTemplate({id: "arma6", x:350,  y:-70,  w:50,  h: 30}),
                   new enemyTemplate({id: "arma7", x:475,  y:-70,  w:50,  h: 30}),
                   new enemyTemplate({id: "arma8", x:600,  y:-70,  w:80,  h: 30}),
                   new enemyTemplate({id: "arma9", x:475,  y:-20,  w:50,  h: 30}),
                   new enemyTemplate({id: "arma10",x: 600, y: -20, w: 50, h: 30}),

                   // Segundo grupo de enemigos
                   new enemyTemplate({ id: "arma11", x: 100, y: -220, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "arma12", x: 225, y: -220, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "arma13", x: 350, y: -220, w: 80, h: 50, image: enemiespic2 }),
                   new enemyTemplate({ id: "arma14", x: 100, y: -270, w: 80, h: 50, image: enemiespic2 }),
                   new enemyTemplate({ id: "arma15", x: 225, y: -270, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "arma16", x: 350, y: -270, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "arma17", x: 475, y: -270, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "arma18", x: 600, y: -270, w: 80, h: 50, image: enemiespic2 }),
                 ];
    ...
    function Launcher(){
        ...
        this.hitDetectLowerLevel = function(enemy){
            ...
            if(enemy.y > 550){
                ...
                this.gameStatus.message = 'weap(s) have passed!';
            }
            ...
            // b) If enemy x is glass than this.x + 45 && enemy x > this.x - 45 then we know theres a collision
